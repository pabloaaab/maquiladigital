...
class Ordenproduccion extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['idcliente', 'estado', 'idtipo','autorizado','facturado','proceso_control','cantidad','aplicar_balanceo','faltante','cerrar_orden'], 'integer'],
            [['fechallegada', 'fechaprocesada', 'fechaentrega'], 'safe'],            
            [['totalorden','ponderacion','porcentaje_proceso','porcentaje_cantidad','segundosficha','duracion'], 'number'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'autorizado' => 'Aut.',
            'ordenproduccion' => 'Orden Int.',
            'ordenproduccionext' => 'Orden Ext.',
            'idtipo' => 'Tipo',
