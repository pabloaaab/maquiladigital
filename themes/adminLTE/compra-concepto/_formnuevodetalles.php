...
$this->title = 'Nuevo Compra Concepto Cuenta';
$this->params['breadcrumbs'][] = ['label' => 'Detalle Compra Concepto', 'url' => ['view', 'id' => $id]];
...
<div class="panel panel-success">
    <div class="panel-heading">
        Información Compra Concepto Cuenta
    </div>
    <div class="panel-body">        
        ...
        <div class="panel-footer text-right">            
            <a href="<?= Url::toRoute(['compra-concepto/view' , 'id' => $id]) ?>" class="btn btn-primary"><span class='glyphicon glyphicon-circle-arrow-left'></span> Regresar</a>
