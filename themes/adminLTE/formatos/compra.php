...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(162, 7, utf8_decode("COMPRA"), 0, 0, 'l', 0);
        $this->Cell(30, 7, utf8_decode('N°. '.str_pad($compra->numero, 4, "0", STR_PAD_LEFT)), 0, 0, 'l', 0);
...
$pdf->Output("Compra$model->numero.pdf", 'D');
