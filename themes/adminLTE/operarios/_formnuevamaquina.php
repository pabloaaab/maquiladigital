...
$this->title = 'Listado de maquinas';
...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute(["operarios/relacionmaquina", 'id' => $id]),
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="buscarmaquina">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute(["operarios/relacionmaquina", 'id' => $id]) ?>" class="btn btn-primary"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
...
<div class="table table-responsive">
    <div class="panel panel-success ">
        <div class="panel-heading">
            Registros : <span class="badge"><?= count($maquinas) ?> </span>
        </div>
        ...
        <div class="panel-footer text-right">
            <?= Html::a('<span class="glyphicon glyphicon-circle-arrow-left"></span> Regresar', ['operarios/view', 'id' => $id], ['class' => 'btn btn-primary btn-sm']) ?>
