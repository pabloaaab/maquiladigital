...
$this->title = 'Nuevo Concepto Nota Cuenta';
$this->params['breadcrumbs'][] = ['label' => 'Detalle Concepto Nota', 'url' => ['view', 'id' => $id]];
...
<div class="panel panel-success">
    <div class="panel-heading">
        Información Concepto Nota Cuenta
    </div>
    <div class="panel-body">        
        ...
        <div class="panel-footer text-right">            
            <a href="<?= Url::toRoute(['conceptonota/view' , 'id' => $id]) ?>" class="btn btn-primary"><span class='glyphicon glyphicon-circle-arrow-left'></span> Regresar</a>
