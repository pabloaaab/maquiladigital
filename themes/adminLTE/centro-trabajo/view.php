...
$this->title = 'Detalle Centro Trabajo';
...
<div class="centro-trabajo-view">
    ...
    <p>
		...
		<?= Html::a('<span class="glyphicon glyphicon-pencil"></span> Editar', ['update', 'id' => $model->id_centro_trabajo], ['class' => 'btn btn-success']) ?>
        <?= Html::a('<span class="glyphicon glyphicon-trash"></span> Eliminar', ['delete', 'id' => $model->id_centro_trabajo], [
