...
$this->params['breadcrumbs'][] = ['label' => 'Pagos permanentes', 'url' => ['index']];
...
<div class="licencia-view">
    ...
    <p>
       <?= Html::a('<span class="glyphicon glyphicon-circle-arrow-left"></span> Regresar', ['index'], ['class' => 'btn btn-primary btn-sm']) ?>
        <?= Html::a('<span class="glyphicon glyphicon-pencil"></span> Editar', ['update', 'id' => $model->id_pago_permanente, 'tipoadicion'=>$model->tipo_adicion], ['class' => 'btn btn-success btn-sm']) ?>
    </p>
