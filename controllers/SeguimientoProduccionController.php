                        ...
                        if ($minutos){
                            if($operarias > 0 && $horastrabajar > 0 && $minutos > 0 ){
                                ...
                                if ($ordenproduccion->cantidad > 0){                                                                            
                                        ...
                                        $cantidad_total_por_hora = round($cantidad_por_hora * $horastrabajar,0);                                        
                                        $total_unidades_por_dia = round($operarias * $cantidad_total_por_hora,0);
                                        $total_unidades_por_hora = round($total_unidades_por_dia / $horastrabajar,0);                                        
                        ...
                        if($operarias > 0 && $horastrabajar > 0 && $minutos > 0 ){
                            ...
                            if ($ordenproduccion->cantidad > 0){
                                /*if($ordenproduccion->segundosficha > 0){*/
                                    ...
                                    $seguimientodetalletemporal->cantidad_total_por_hora = round($seguimientodetalletemporal->cantidad_por_hora * $seguimientodetalletemporal->horas_a_trabajar,0);
                                    $seguimientodetalletemporal->operarias = $operarias;
                                    $seguimientodetalletemporal->total_unidades_por_dia = round($operarias * $seguimientodetalletemporal->cantidad_total_por_hora,0);
