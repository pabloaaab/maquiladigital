...
insert  into `facturaventa`(`nrofactura`,`fechainicio`,`fechavcto`,`formapago`,`plazopago`,`porcentajeiva`,`porcentajefuente`,`porcentajereteiva`,`subtotal`,`retencionfuente`,`impuestoiva`,`retencioniva`,`totalpagar`,`valorletras`,`idcliente`,`idordenproduccion`,`usuariosistema`) values 
(1,'2018-10-15','2018-10-15','credito',30,1,1,1,1000,1,1,1,1000,'cccccc\r\n',2,1,'admin');
...
insert  into `facturaventadetalle`(`iddetallefactura`,`nrofactura`,`idproducto`,`codigoproducto`,`cantidad`,`preciounitario`,`total`) values 
(2,1,1,'5210',100,10,11000),
(3,1,1,'5210',150,20,25441);
...
insert  into `ordenproduccion`(`idordenproduccion`,`idcliente`,`fechallegada`,`fechaprocesada`,`fechaentrega`,`totalorden`,`valorletras`,`observacion`,`estado`,`usuariosistema`) values 
(1,2,'2018-10-15','2018-10-15','2018-10-15','1000','czczx','czxcx','0','admin');
...
CREATE TABLE `ordenproducciondetalle` (
  ...
  CONSTRAINT `ordenproducciondetalle_ibfk_2` FOREIGN KEY (`idordenproduccion`) REFERENCES `ordenproduccion` (`idordenproduccion`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

/*Data for the table `ordenproducciondetalle` */

insert  into `ordenproducciondetalle`(`iddetalleorden`,`idproducto`,`cantidad`,`vlrprecio`,`subtotal`,`idordenproduccion`) values 
(2,1,100,500,5000,1);
...
(1,'5010','dfdf',500,500,500,5000,2,'gfggfgf','1','2018-10-15 19:47:06','ADMON');
...
insert  into `recibocajadetalle`(`iddetallerecibo`,`nrofactura`,`vlrabono`,`vlrsaldo`,`retefuente`,`reteiva`,`reteica`,`idrecibo`,`observacion`) values 
(7,1,1200,1000,1,2,3,1,'holas'),
(8,1,1500,1500,1,1,1,1,'hola 1'),
(9,1,1000,1000,4,4,4,1,'hola4'),
(10,1,2000,2000,3,5,4,2,'hola 5');
