...
(25,2,'2018-10-18 09:36:39','2018-10-18 09:36:42','2018-10-18 09:36:46',43666,'ghghg ghghg ghghg','HJ HJHJ',0,'521LJ',1,'admin'),
...
CREATE TABLE `producto` (
  ...
  `idcliente` int(11) NOT NULL,
  `observacion` longtext NOT NULL,
  `activo` char(2) NOT NULL DEFAULT '0',
...
(1,'5010','PRENDA LADO DERECHO BLUSA',500,500,500,5000,2,'gfggfgf','1','2018-10-15 19:47:06','ADMON'),
(2,'5241dd','FLECO INTERIOR DERECHO',10,10,550,600,2,'SDSDDSDS','1','2018-10-15 19:47:06','ADMON'),
(3,'E453569','FLECO EXPTERIOR INZQUIERDO',120,120,582,562,2,'SDSDSD','1','2018-10-15 19:47:06','ADMON'),
(4,'dfd4','fdfdfdf',33,33,33,33,2,'sdds','','0000-00-00 00:00:00','ADMON'),
(5,'dfe45','dddcc',34,34,34,34,2,'dsd','','0000-00-00 00:00:00','ADMON'),
(6,'w34','fffff',35,35,335,355,2,'wwwww','','2018-10-22 21:59:38','ADMON'),
(7,'dfd4','PRENDA LADO DERECHO BLUSA',33,33,33,33,3,'dgdg','','2018-10-22 22:22:51','ADMON');
...
CREATE TABLE `recibocajadetalle` (
  ...
  CONSTRAINT `recibocajadetalle_ibfk_3` FOREIGN KEY (`nrofactura`) REFERENCES `facturaventa` (`nrofactura`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
