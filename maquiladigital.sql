...
insert  into `ordenproduccion`(`idordenproduccion`,`idcliente`,`fechallegada`,`fechaprocesada`,`fechaentrega`,`totalorden`,`valorletras`,`observacion`,`estado`,`ordenproduccion`,`usuariosistema`) values 
(1,3,'2018-10-10 00:00:00','2018-10-10 00:00:00','2018-10-10 00:00:00',10000,NULL,'SDSDS',0,'1010','71268830'),
(24,12,'2018-10-17 00:00:00','2018-10-17 00:00:00','2018-10-17 00:00:00',0,NULL,'DDD',0,'4152','71268830');
...
CREATE TABLE `ordenproducciondetalle` (
  ...
  CONSTRAINT `ordenproducciondetalle_ibfk_3` FOREIGN KEY (`idordenproduccion`) REFERENCES `ordenproducciondetalle` (`iddetalleorden`)
